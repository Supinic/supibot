CREATE TABLE IF NOT EXISTS `chat_data`.`Filter` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `User_Alias_Channel_Command` (`User_Alias`,`Channel`,`Command`,`Type`,`Blocked_User`,`Platform`) USING BTREE,
