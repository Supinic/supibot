CREATE TABLE IF NOT EXISTS `chat_data`.`Command` (
	...
	`Flags` SET('archived','block','developer','external-input','link-only','mention','opt-out','owner-override','ping','pipe','read-only','rollback','skip-banphrase','system','use-params','whitelist') NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
