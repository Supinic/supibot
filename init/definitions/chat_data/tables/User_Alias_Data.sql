CREATE TABLE IF NOT EXISTS `chat_data`.`User_Alias_Data` (
	...
	CONSTRAINT `FK_User_Data_User_Data_Property` FOREIGN KEY (`Property`) REFERENCES `chat_data`.`User_Alias_Data_Property` (`Name`) ON UPDATE CASCADE ON DELETE CASCADE
)
