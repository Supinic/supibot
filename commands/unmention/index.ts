...
export default declare({
	...
	Dynamic_Description: (prefix) => ([
		...
		`<code>${prefix}unmention id:(ID)</code>`,
		`<code>${prefix}remention id:(ID)</code>`,
		...
		`<code>${prefix}unmention channel:(channel name)</code>`,
		`<code>${prefix}unmention platform:(platform name)</code>`,
