...
export default declare({
	...
	Dynamic_Description: (prefix) => ([
		...
		`<code>${prefix}block (user) (command)</code>`,
		`<code>${prefix}block user:(user) command:(command)</code>`,
		`<code>${prefix}block Kappa rl</code>`,
		`<code>${prefix}block user:Kappa command:rl</code>`,
		`Blocks the user Kappa from using the command rl on you. Then, they can't do <code>${prefix}rl (your name)</code>`,
		"",

		`<code>${prefix}unblock (user) (command)</code>`,
		`Unblocks the user from a given command.`,
		"",

		`<code>${prefix}block (user) all</code>`,
		`<code>${prefix}block user:(user) command:all</code>`,
		...
		`<code>${prefix}block id:(ID)</code>`,
		`<code>${prefix}unblock id:(ID)</code>`,
