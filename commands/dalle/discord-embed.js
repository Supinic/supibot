...
const createEmbeds = function createDiscordEmbed (id, options = {}) {
	...
	for (let i = 0; i < 9; i++) {
		const obj = {
			...
			image: `https://supinic.com/data/dall-e/detail/${id}/preview/${i}`
		};
		...
		if (i === 0) {
			...
			obj.footer = {
				text: `Generated by the DALL-E API on ${dateString} in ${time} seconds, as available on [HuggingFace](https://huggingface.co/spaces/dalle-mini/dalle-mini).`
			};
		}
